...
from parsers.electionware.csv import get_output_file_path, get_output_header, \
    write_electionware_pdf_to_csv, _write_electionware_pdf_to_csv
...
class TestCSV(TestCase):
    def test__pdf_to_csv(self):
        with patch('parsers.electionware.csv._write_electionware_pdf_to_csv') as mock:
            configuration = {
